...
/** 
 * DAO for table DEPENDENCY_DISAPPEAR_LOCAL_OBJECT.
*/
public class DependencyDisappearLocalObjectDao extends AbstractDao<DependencyDisappearLocalObject, Long> {

    public static final String TABLENAME = "DEPENDENCY_DISAPPEAR_LOCAL_OBJECT";

    /**
     * Properties of entity DependencyDisappearLocalObject.<br/>
    ...
    */
    ...
    private Query<DependencyDisappearLocalObject> dependencyDisappearLocalObject_ChildDepsQuery;

    public DependencyDisappearLocalObjectDao(DaoConfig config) {
        super(config);
    }
    
    public DependencyDisappearLocalObjectDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'DEPENDENCY_DISAPPEAR_LOCAL_OBJECT' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DEPENDENCY_DISAPPEAR_LOCAL_OBJECT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DependencyDisappearLocalObject entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(DependencyDisappearLocalObject entity) {
    ...
    /** @inheritdoc */
    @Override
    public DependencyDisappearLocalObject readEntity(Cursor cursor, int offset) {
        DependencyDisappearLocalObject entity = new DependencyDisappearLocalObject( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DependencyDisappearLocalObject entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DependencyDisappearLocalObject entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DependencyDisappearLocalObject entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    /** Internal query to resolve the "childDeps" to-many relationship of DependencyDisappearLocalObject. */
    public List<DependencyDisappearLocalObject> _queryDependencyDisappearLocalObject_ChildDeps(Long parentDependency) {
        synchronized (this) {
            if (dependencyDisappearLocalObject_ChildDepsQuery == null) {
                QueryBuilder<DependencyDisappearLocalObject> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ParentDependency.eq(null));
                dependencyDisappearLocalObject_ChildDepsQuery = queryBuilder.build();
            }
        }
        Query<DependencyDisappearLocalObject> query = dependencyDisappearLocalObject_ChildDepsQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM DEPENDENCY_DISAPPEAR_LOCAL_OBJECT T");
    ...
    protected DependencyDisappearLocalObject loadCurrentDeep(Cursor cursor, boolean lock) {
        DependencyDisappearLocalObject entity = loadCurrent(cursor, 0, lock);
    ...
    public DependencyDisappearLocalObject loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<DependencyDisappearLocalObject> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<DependencyDisappearLocalObject> list = new ArrayList<DependencyDisappearLocalObject>(count);
    ...
    protected List<DependencyDisappearLocalObject> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<DependencyDisappearLocalObject> queryDeep(String where, String... selectionArg) {
